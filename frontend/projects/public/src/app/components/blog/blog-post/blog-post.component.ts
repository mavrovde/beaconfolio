        ...
        @if (vm$ | async; as vm) {
          <div class="max-w-4xl mx-auto">
            ...
            @switch (vm.status) {
              ...
              @case ('found') {
                ...
                <div class="mb-8 space-y-2">
                  ...
                  <div class="flex flex-wrap gap-2 mt-4">
                    @for (tag of vm.post!.tags; track tag) {
                      <span class="text-xs border border-terminal-dim text-secondary px-2 py-1 rounded">
                        #{{ tag }}
                      </span>
                    }
                  </div>
              ...
              @case ('notfound') {
                <div class="py-16 text-center space-y-6" data-testid="post-not-found">
